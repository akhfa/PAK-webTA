...
<div class="wrap">
	...
	<div class="header-right">
	 	 <ul class="nav">
             ...
             <li class="active"><a href="<?php echo base_url() ?>index.php/about">Tentang Kami</a></li>
...
<div class="content">
 ...
 <div class="sidebar">
  <div class="side_bar">
 	<h2>Catogories</h2>
 	<p class="top"><a href="<?php echo base_url()?>"><img src="<?php echo base_url()?>images/art-pic1.jpg" alt="">Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi aliquip consequat.</a></p>
 	<p class="top"><a href="<?php echo base_url()?>"><img src="<?php echo base_url()?>images/art-pic2.jpg" alt="">Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi aliquip consequat.</a></p>
...
<div class="footer">
		...
		<div class="copy">
			<p class="w3-link">© All Rights Reserved | Design by&nbsp; <a href="<?php echo base_url()?>http://w3layouts.com/"> W3Layouts</a></p>
 		</div>
 		</div>
		<div class="f_grid">
		<div class="social">
				<ul class="follow_icon">
						<li><a href="<?php echo base_url()?>#" style="opacity: 1;">Get Updates Via</a></li>
					<li><a href="<?php echo base_url()?>#" style="opacity: 1;"><img src="<?php echo base_url()?>images/fb.png" alt=""></a></li>
					<li><a href="<?php echo base_url()?>#" style="opacity: 1;"><img src="<?php echo base_url()?>images/g+.png" alt=""></a></li>
					<li><a href="<?php echo base_url()?>#" style="opacity: 1;"><img src="<?php echo base_url()?>images/tw.png" alt=""></a></li>
					<li><a href="<?php echo base_url()?>#" style="opacity: 1;"><img src="<?php echo base_url()?>images/rss.png" alt=""></a></li>
				</ul>
			</div>
		</div>
		<div class="f_grid1">
